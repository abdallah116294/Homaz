...
class ApartmentRepo {
  ...
  Future<Either<Failure, FavoriteModel>> addToFavoirte({required int id}) async {
    try {
      final response = await apiConsumer.post(ApiConstants.addOrRemoveFavoirte+id.toString());
