class AssetsStrings {
  ...
  // Images
  static const String splashBg = "${baseImages}splash.png";
  static const String onBoarding1 = "${baseImages}onBoarding1.png";
  static const String onBoarding2 = "${baseImages}onBoarding2.png";
  static const String onBoarding3 = "${baseImages}onBoarding3.png";
  static const String successImage = "${baseImages}success_image.png";
  static const String detailsImage = "${baseImages}details_image.png";
  ...
  static const String send = "${baseIcons}send.svg";
  static const String heart = "${baseIcons}heart.svg";
  static const String heartFillRed = "${baseIcons}heart_fill_red.svg";
  static const String bath = "${baseIcons}bath.svg";
  static const String bed = "${baseIcons}bed.svg";
  static const String widget = "${baseIcons}widget.svg";
  static const String bell = "${baseIcons}bell.svg";
  static const String language = "${baseIcons}language.svg";
  ...
  static const String home1 = "${baseIcons}home1.svg";
  static const String home2 = "${baseIcons}home2.svg";
